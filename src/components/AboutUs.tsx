...
const values = [
  {
    ...
    description:
      "Every service we build starts with one question: does this make drivers safer?",
  ...
  },
  {
    ...
    description:
      "Every hotel, restaurant, lawyer, and support partner is vetted before joining us.",
  ...
  },
  {
    ...
    description:
      "24x7 support means help is never more than a call away, wherever the road takes you.",
    icon: "time-outline",
  },
];
...
const AboutUs = () => {
  ...
  return (
    ...
    >
      <Image
        source={require("@/assets/images/ma-splash-logo.png")}
      ...
      <View style={styles.valuesCard}>
        {values.map((value, index) => (
          <View
            ...
            style={[
              styles.valueRow,
              index !== values.length - 1 && styles.valueRowBorder,
            ]}
          >
          ...
          <View key={link.id}>
            ...
            {openLegalId === link.id && (
              <View style={styles.legalContent}>
                <Text style={styles.legalContentText}>{t(link.content)}</Text>
              </View>
            )}
      ...
      <View style={styles.footer}>
        ...
        <Text style={styles.copyrightText}>
          {t("© 2026 Miles Assist. All rights reserved.")}
        </Text>
      </View>
